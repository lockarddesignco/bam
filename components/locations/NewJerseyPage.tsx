...
export const NewJerseyPage: React.FC<NewJerseyPageProps> = ({ onNavigate }) => {
  return (
    <div className="bg-[#F7F9F8] font-sans selection:bg-[#A7D7C5] selection:text-[#265A4A]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-4xl">
             ...
             <h1 className="text-4xl md:text-7xl font-bold text-white mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-[#A7D7C5]">Operational Responsibility: NJ</span>
             </h1>
             <p className="text-[#D7DDDA] text-lg md:text-xl font-light leading-relaxed border-l-2 border-[#265A4A] pl-8 opacity-90 max-w-2xl mb-10">
                Coordinated mechanical restoration and technical oversight for mission-critical facilities, pharmaceutical campuses, and multi-site portfolios across New Jersey.
             </p>
             <div className="flex flex-col sm:flex-row items-center gap-6">
               ...
               <div className="text-xs font-bold text-[#A7D7C5] uppercase tracking-widest opacity-80 max-w-[200px]">
                 Statewide governance and routing for NJ facilities.
               </div>
             </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-4">
               ...
               <h3 className="text-3xl font-bold text-[#265A4A] leading-tight">Garden State Portfolio Management</h3>
            </div>
            <div className="lg:col-span-8">
               <p className="text-[#5E7A86] text-lg leading-relaxed font-light mb-8">
                  This documentation is provided for facility governance roles managing multi-site campus environments or institutional portfolios with statewide compliance exposure. It serves as the primary coordination layer to ensure unified technical standards across NJ's diverse industrial and corporate zones.
               </p>
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-[#F7F9F8] border border-[#D7DDDA] rounded-sm">
                    ...
                    <p className="text-xs text-[#5E7A86] leading-relaxed">Centralized management of pharmaceutical manufacturing, higher education campuses, and healthcare networks requiring cross-regional consistency.</p>
                  </div>
                  <div className="p-8 bg-[#F7F9F8] border border-[#D7DDDA] rounded-sm">
                    <h4 className="font-bold text-[#265A4A] text-sm uppercase tracking-widest mb-4">Risk & Procurement Alignment</h4>
                    <p className="text-xs text-[#5E7A86] leading-relaxed">Decision-makers qualifying a single technical partner for high-stakes mechanical restoration across New Jersey's regulatory landscape.</p>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-[#F2F6F5]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-3xl mb-16">
             <h2 className="text-3xl font-bold text-[#265A4A] mb-6">Operational Scope in New Jersey</h2>
             <p className="text-[#5E7A86] text-lg font-light leading-relaxed">
                We coordinate specialized mechanical restoration and air hygiene services statewide. This scope focuses on the preservation of existing capital assets and the verification of indoor environmental quality across industrial and commercial sectors.
             </p>
          </div>
      ...
      <section className="py-24 bg-white border-y border-[#D7DDDA]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Pharma & Life Sciences", desc: "Laboratories and manufacturing sites requiring strict air change rates.", icon: Stethoscope },
                { title: "Higher Education", desc: "University campuses and research facilities managing seasonal loads.", icon: GraduationCap },
                { title: "Corporate Campuses", desc: "Large-scale office parks requiring tenant comfort and efficiency.", icon: Building2 },
                { title: "Industrial Parks", desc: "Manufacturing and logistics hubs focused on process continuity.", icon: Factory }
              ].map((item, i) => (
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                 ...
                 <p className="text-[#5E7A86] text-lg font-light leading-relaxed mb-6">
                    BAM maintains active field operations across New Jersey. While we provide centralized governance for the entire state, execution is anchored by regional technical teams to ensure rapid response and localized supply chain logistics.
                 </p>
                 <ul className="space-y-3">
                    {[
                      "North Jersey (Pharma & Industrial Corridor)",
                      "Central Jersey (Corporate & Education Hubs)",
                      "South Jersey (Philadelphia Metro Alignment)",
                      "Coastal Institutional Facilities"
                    ].map((region, i) => (
              ...
              <div className="p-10 border border-[#D7DDDA] bg-white hover:border-[#A7D7C5] transition-colors">
                 ...
                 <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 border border-[#D7DDDA] rounded-sm cursor-pointer hover:bg-[#F7F9F8] transition-colors">
                       <span className="text-xs font-bold text-[#265A4A] uppercase tracking-widest">North Jersey Metro</span>
                       <ArrowRight className="w-3 h-3 text-[#A7D7C5]" />
                    </div>
                    <div className="flex items-center justify-between p-3 border border-[#D7DDDA] rounded-sm cursor-pointer hover:bg-[#F7F9F8] transition-colors">
                       <span className="text-xs font-bold text-[#265A4A] uppercase tracking-widest">South Jersey / Philadelphia Zone</span>
                       <ArrowRight className="w-3 h-3 text-[#A7D7C5]" />
                    </div>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                 <div className="p-6 bg-[#265A4A]/20 border border-[#A7D7C5]/20">
                    ...
                    <p className="text-xs text-[#D7DDDA] leading-relaxed">
                       Registered status with major pharmaceutical and healthcare networks.
                    </p>
                 </div>
                 <div className="p-6 bg-[#265A4A]/20 border border-[#A7D7C5]/20">
                    <div className="flex items-center gap-3 mb-3">
                 ...
                 <div className="p-6 bg-[#265A4A]/20 border border-[#A7D7C5]/20">
                    <div className="flex items-center gap-3 mb-3">
                       ...
                       <h4 className="font-bold text-white text-xs uppercase tracking-widest">Regulated Sites</h4>
                    </div>
                    <p className="text-xs text-[#D7DDDA] leading-relaxed">
                       Experience working within FDA/GMP validated manufacturing environments.
                    </p>
                 </div>
              </div>
           </div>
      ...
      <section className="py-24 bg-white border-t border-[#D7DDDA]">
        <div className="max-w-4xl mx-auto px-6 text-center">
           <h2 className="text-3xl md:text-5xl font-bold text-[#265A4A] mb-8 tracking-tight">Confirm NJ Portfolio Alignment</h2>
           <p className="text-[#5E7A86] text-lg mb-12 font-light max-w-2xl mx-auto opacity-90">
             Initiate the confirmation process to verify eligibility and coordinate routing for your New Jersey-based facility or regional portfolio.
           </p>
      ...
      <section className="py-8 bg-[#F7F9F8] border-t border-[#D7DDDA] text-[10px] font-mono text-[#5E7A86] text-center opacity-60">
         URL: /locations/new-jersey/ | PARENT: /locations/ | TYPE: STATE_AUTHORITY | PURPOSE: GOVERNANCE_COORDINATION
      </section>
