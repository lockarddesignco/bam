...
import { 
  ...
  HardHat, Navigation, Phone, ArrowRight, Warehouse,
  ClipboardList, AlertTriangle, CheckCircle2, FileText
} from 'lucide-react';
import { Button } from '../Button';
import { Page } from '../../App';

interface SouthJerseyPageProps {
  onNavigate: (page: Page) => void;
}

export const SouthJerseyPage: React.FC<SouthJerseyPageProps> = ({ onNavigate }) => {
  return (
    <div className="bg-[#F7F9F8] font-sans selection:bg-[#A7D7C5] selection:text-[#265A4A]">
      ...
      <section className="relative pt-40 pb-24 bg-[#1A1F1E] overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1596237553551-768d89326262?auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-3xl">
             ...
             <p className="text-[#D7DDDA] text-lg font-light leading-relaxed border-l-2 border-[#A7D7C5] pl-6 opacity-90 max-w-xl mb-8">
                Mechanical execution services for the industrial, logistical, and commercial corridors of Southern New Jersey.
             </p>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <div>
                 ...
                 <p className="text-[#5E7A86] text-lg font-light leading-relaxed mb-8">
                    This operational hub is strictly for <strong>Site Managers, Plant Engineers, and Local Facility Operators</strong> requiring physical execution at a specific address within the South Jersey region.
                 </p>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-[#F7F9F8] border border-[#D7DDDA]">
                       ...
                       <ul className="text-xs text-[#5E7A86] space-y-2">
                          <li>• Warehouse HVAC Failures</li>
                          <li>• Industrial PM Shutdowns</li>
                          <li>• Commercial Fit-Out Cleaning</li>
                    ...
                    <div className="p-4 bg-[#F7F9F8] border border-[#D7DDDA]">
                       ...
                       <ul className="text-xs text-[#5E7A86] space-y-2">
                          <li>• Logistics & Distribution Ctrs</li>
                          <li>• Manufacturing Plants</li>
                          <li>• Medical/Ed Campuses</li>
              ...
              <div className="bg-[#265A4A] p-10 text-white rounded-sm flex flex-col justify-center relative overflow-hidden">
                 ...
                 <div className="relative z-10">
                    ...
                    <p className="text-[#D7DDDA] text-sm leading-relaxed mb-6">
                       If you are a <strong>Director of Facilities</strong> or <strong>Procurement Officer</strong> managing a statewide portfolio or negotiating a New Jersey-wide contract, please proceed to the State Authority page.
                    </p>
                    <Button variant="outline" className="!text-white !border-white/30 hover:!bg-white/10" onClick={() => onNavigate('new-jersey')}>
                       Go to NJ State Governance
                    </Button>
                 </div>
              </div>
           </div>
      ...
      <section className="py-20 bg-[#F2F6F5] border-b border-[#D7DDDA]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
           ...
           <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              ...
              {[
                { step: "01", title: "Intake & Dispatch", desc: "Digital or phone request routes to the South Jersey field desk." },
                { step: "02", title: "Site Scout", desc: "Lead technician deploys (24-48 hrs) for scope and safety check." },
                { step: "03", title: "Mobilization", desc: "Crew arrival with appropriate equipment for industrial/commercial access." },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
           <div className="mb-12">
              <h2 className="text-3xl font-bold text-[#265A4A] mb-6">South Jersey Execution Capabilities</h2>
              <p className="text-[#5E7A86] max-w-3xl leading-relaxed">
                 Field crews in this zone are focused on supporting the heavy industrial, warehousing, and commercial sectors prevalent in the region.
              </p>
           </div>

           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="border border-[#D7DDDA] p-8 hover:border-[#265A4A] transition-colors">
                 <Warehouse className="w-8 h-8 text-[#265A4A] mb-6" />
                 <h4 className="font-bold text-[#265A4A] text-sm uppercase tracking-widest mb-4">Warehousing & Logistics</h4>
                 <ul className="space-y-3 text-sm text-[#5E7A86]">
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Distribution center HVAC</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> High-bay duct cleaning</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Rooftop unit maintenance</li>
                 </ul>
              </div>
              <div className="border border-[#D7DDDA] p-8 hover:border-[#265A4A] transition-colors">
                 <ShieldCheck className="w-8 h-8 text-[#265A4A] mb-6" />
                 <h4 className="font-bold text-[#265A4A] text-sm uppercase tracking-widest mb-4">Industrial Hygiene</h4>
                 <ul className="space-y-3 text-sm text-[#5E7A86]">
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Process byproduct management</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Air quality testing</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Mold remediation</li>
                 </ul>
              </div>
              <div className="border border-[#D7DDDA] p-8 hover:border-[#265A4A] transition-colors">
                 <Building2 className="w-8 h-8 text-[#265A4A] mb-6" />
                 <h4 className="font-bold text-[#265A4A] text-sm uppercase tracking-widest mb-4">Commercial Support</h4>
                 <ul className="space-y-3 text-sm text-[#5E7A86]">
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Retail complex cleaning</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Office park IAQ</li>
                    <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-[#A7D7C5]" /> Medical facility hygiene</li>
                 </ul>
              </div>
           </div>
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                 ...
                 <p className="text-[#5E7A86] leading-relaxed mb-6">
                    South Jersey crews prioritize safety and rapid response, understanding the critical nature of industrial and commercial operations.
                 </p>
                 <div className="space-y-4">
                    <div className="flex gap-4 p-4 bg-white border border-[#D7DDDA] rounded-sm">
                       <Truck className="w-5 h-5 text-[#265A4A] shrink-0" />
                       <div>
                          <h4 className="font-bold text-[#265A4A] text-xs uppercase tracking-widest">Rapid Response</h4>
                          <p className="text-sm text-[#5E7A86]">Quick deployment for industrial shutdowns and critical failures.</p>
                       </div>
                    </div>
                    <div className="flex gap-4 p-4 bg-white border border-[#D7DDDA] rounded-sm">
                       ...
                       <div>
                          ...
                          <p className="text-sm text-[#5E7A86]">Strict adherence to OSHA and industrial site safety protocols.</p>
                       </div>
                    </div>
                 </div>
              </div>
              <div className="bg-white p-8 border border-[#D7DDDA] shadow-sm">
                 ...
                 <ul className="space-y-4 text-sm text-[#5E7A86]">
                    <li className="flex items-start gap-3">
                       ...
                       <span><strong>Primary Zone:</strong> Camden, Burlington, Gloucester counties.</span>
                    </li>
                    <li className="flex items-start gap-3">
                       <MapPin className="w-4 h-4 text-[#A7D7C5] mt-1" />
                       <span><strong>Extended Zone:</strong> Atlantic County, Shore Region.</span>
                    </li>
                    <li className="flex items-start gap-3">
      ...
      <section className="py-20 bg-[#1A1F1E] border-t border-[#A7D7C5]/10">
         <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Initiate South Jersey Site Support</h2>
            <p className="text-[#D7DDDA] mb-10 max-w-lg mx-auto">Contact our regional field office to arrange a site evaluation or technical service.</p>
